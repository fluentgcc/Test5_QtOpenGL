...
public:
	...
	* @private
	*/
	explicit VertexAttribute(	gl::GLchar * name,
						gl::GLint size,
						gl::GLenum type,
	...
	*/
	...
	//----set----
	void			setPointer(gl::GLvoid * pointer) { this->pointer_ = pointer; }
	void			setStride(gl::GLsizei stride) { this->stride_ = stride; }
	//----get----
	gl::GLenum		getType() { return this->type_; }
	gl::GLint		getSize() { return this->size_; }
	gl::GLchar*		getName() { return this->name_; }
	gl::GLvoid*		getPointer(){ return this->pointer_; }
private:
    /**
     *  atribute name
     */
